...
#put everything into lowercase letters
  ...
  mutate(response = case_when(
    item == "gender" & response %in% c("female", "f") ~ "female",  # Map to "female"
    item == "gender" & response %in% c("male", "m") ~ "male", 
    item == "gender" & response %in% c("non binary", "non-binary", "nb") ~ "non binary", 
    item == "gender" ~ NA_character_,  #set all responses that werent covered in the code above to "NA"
    TRUE ~ response  # Keep other responses unchanged (like age)
  ))
